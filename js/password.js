...
// 密码验证功能已禁用，所有校验永远通过
// ========================
window.isPasswordProtected = () => false; // 表示未启用密码保护
window.isPasswordVerified = () => true;   // 总是已验证
window.isAdminVerified = () => true;      // 总是已验证
window.verifyPassword = async () => true; // 总是验证通过
